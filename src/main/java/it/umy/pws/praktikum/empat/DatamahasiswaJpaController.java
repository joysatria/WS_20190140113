 ...
 */
package it.umy.pws.praktikum.empat;

import it.umy.pws.praktikum.empat.exceptions.NonexistentEntityException;
import it.umy.pws.praktikum.empat.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("it.umy_pws.praktikum.empat_jar_0.0.1-SNAPSHOTPU");
